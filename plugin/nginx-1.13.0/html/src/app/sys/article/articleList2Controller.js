...
angular.module('app')
	.controller('articleList2Controller', ['$rootScope', '$scope', '$http', '$state',
	     function ($rootScope, $scope, $http, $state) {
	         ...
	         //$scope.mId = '';
	         $scope.menuName = "栏目管理";
	         $scope.categoryUrl = "main.article.category2";
	         switch ($scope.param.typeCode) {
	             ...
	             case '19':
	                 ...
	                 $scope.categoryUrl = "main.faults.category2";
	                 break;
	             case '20':
	                 $scope.title = '发展资料';
	                 $scope.menuName = "党员发展";
	                 $scope.categoryUrl = "main.partyner.category2";
	                 break;
	             default:
	                 $scope.title = '党建快报';
	                 break;
	         ...
	         $scope.addInfo = function () {
	             if ($scope.cateAndImg.isCategory == 1) {//有分类
	                 ...
	                 if (typeLength > 0) {
	                     $state.go('main.article.form2', { typeCode: $scope.param.typeCode, id: '', mId: $scope.cateAndImg.id });
	                 } else {
	                     alertDialog("请先添加分类", 2);
	                  
	                 }
	             } else {
	                 $state.go('main.article.form2', { typeCode: $scope.param.typeCode, id: '', mId: '' });
	             }
	         }
