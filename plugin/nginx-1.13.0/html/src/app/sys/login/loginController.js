                ...
                $.ajax({
                    ...
                    if (result.httpCode == 200) {
                        ...
                        if (returnUrl != "" && returnUrl != undefined) {
                            ...
                            if ($.inArray('main.system.partyhome.query', $rootScope.permissionList) != -1) {
                                $state.go('main.system.partyhome');
                            }
                            else if ($.inArray('main.system.branchhome.query', $rootScope.permissionList) != -1) {
                                $state.go('main.system.branchhome');
                            }
                            else {
