...
angular.module('app')
	.controller('orgImportController', ['$rootScope', '$scope', '$http', '$state',
	  function ($rootScope, $scope, $http, $state) {
	      ...
	      function getExcel() {
	          ...
	          $.ajax({
	              type: 'get',
	              url: '/iBase4J-SYS-Web/dept/read/exportDeptExcel',
	      ...
	      var submit = function () {
	          ...
	          $("#importUser").ajaxSubmit({
	              type: 'post',
	              url: '/iBase4J-SYS-Web/dept/read/addExcel',
	              contentType: "application/x-www-form-urlencoded; charset=utf-8",
	              clearForm: "true",
