...
app.register.controller('classifyCtrl', function ($rootScope, $scope, httpAjax, $http) {
    ...
    /* 获取表格 */
    $rootScope.searchTable('8060', '/goods/class/back/query?rootid=&backModuleId=' + $rootScope.backModuleId + '&page=0');
    /* 点击查询 */
    $scope.search.searchFun = function () {
        $scope.tableUrl = '/goods/class/back/query?rootid=' + $scope.search.rootid + '&backModuleId=' + $rootScope.backModuleId + '&page='+ ($scope.search.page - 1);
