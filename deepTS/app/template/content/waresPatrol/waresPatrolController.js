 ...
 */
app.register.controller('waresPatrolCtrl', function ($rootScope, $scope, $http, $location) {
    layer.closeAll();
    ...
    $scope.search.searchFun = function () {
        ...
        $scope.tableUrl = '/goods/activity/back/activity/query?date=' + $scope.search.date + '&goodsclassid=' + $scope.search.goodsclassid + '&brandid=' + $scope.search.brandid + '&ishot=' + $scope.search.isHot + '&page=' + $rootScope.table.pageInfo.number;
    ...
    $scope.goDetail = function (id) {
        $location.path('/waresPatrols/detail/' + (id ? id : -1) );
    }
